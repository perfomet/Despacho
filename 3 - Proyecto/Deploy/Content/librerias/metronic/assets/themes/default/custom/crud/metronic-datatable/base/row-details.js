var DatatableAutoColumnHideDemo = {
	init: function () {
		$(".m_datatable").mDatatable({
			data: {
				type: "remote", source: { read: { url: "inc/api/datatables/demos/default.php" } },
			...
			search: { input: $("#generalSearch") }, rows: { autoHide: !0 },
			columns: [
				{ field: "OrderID", title: "Order ID", width: 150, template: "{{OrderID}} - {{ShipCountry}}" },
				{ field: "ShipCountry", title: "Ship Country", width: 150, template: function (t) { return t.ShipCountry + " - " + t.ShipCity } }, { field: "ShipCity", title: "Ship City" },
...
}; jQuery(document).ready(function () { DatatableAutoColumnHideDemo.init() });