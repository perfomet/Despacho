var DatatableRemoteAjaxDemo = {
    init: function () {
        ...
        t = $(".m_datatable").mDatatable({
            ...
            search: {
            ...
            }, columns: [
                {
                    ...
                    field: "ShipCountry", title: "Ship Country", attr: { nowrap: "nowrap" }, width: 150, template: function (t) { return t.ShipCountry + " - " + t.ShipCity }
                }, {
                    ...
                    field: "Type", title: "Type", template: function (t) { var e = { 1: { title: "Online", state: "danger" }, 2: { title: "Retail", state: "primary" }, 3: { title: "Direct", state: "accent" } }; return '<span class="m-badge m-badge--' + e[t.Type].state + ' m-badge--dot"></span>&nbsp;<span class="m--font-bold m--font-' + e[t.Type].state + '">' + e[t.Type].title + "</span>" }
                }, {
        ...
        }), $("#m_form_status").on("change", function () { t.search($(this).val(), "Status") }), $("#m_form_type").on("change", function () { t.search($(this).val(), "Type") }), $("#m_form_status, #m_form_type").selectpicker()
    }
};
