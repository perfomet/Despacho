...
namespace Datos.Datos
{
	public class Solicitud
	{
		...
		public static List<Modelo.Solicitud> ObtenerSolicitudes()
		{
		...
		public static bool Crear(Modelo.Solicitud solicitud)
		{
		...
		public static bool Modificar(Modelo.Solicitud solicitud)
		{
			...
			string SETSentence2 = " SET ComunaClienteId = {9}, NumeroTelefonoContacto = '{10}', RutCliente = '{11}', VRutCliente = '{12}', Proyecto = '{13}', PrioridadId = {14}, UnidadNegocioId = {15}, GerenciaId = {16}";
			string SETSentence3 = " SET ObservacionAof = '{17}', FechaDespacho = '{18}', PatenteCamion = '{19}', LlamadaDiaAnterior = {20}, ComentariosLlamada = '{21}', EnlaceId = {22}, NumeroDocumento = {23}, NumeroEntrega = {24}";
			string SETSentence4 = " SET FechaEntregaDocumento = '{25}', FechaRecepcionDocumento = '{26}', Folio = {27}, TipoDocumentoId = {28}, Concrecion = {29}, NombreConcrecion = '{30}', RUTConcrecion = '{31}', VRUTConcrecion = '{32}', MotivoNoConcrecion = '{33}'";
			...
			builder.AppendFormat(SQLSentence,
				solicitud.SolicitudDespachoId, solicitud.EstadoSolicitudId, solicitud.FechaSolicitud, solicitud.FechaRecepcion, solicitud.BodegaOrigen, solicitud.NumeroCliente, solicitud.NombreCliente, solicitud.DireccionCliente,
				...
				solicitud.ObservacionAof, solicitud.FechaDespacho, solicitud.PatenteCamion, solicitud.LlamadaDiaAnterior, solicitud.ComentariosLlamada, solicitud.EnlaceId, solicitud.NumeroDocumento, solicitud.NumeroEntrega,
				solicitud.FechaEntregaDocumento, solicitud.FechaRecepcionDocumento, solicitud.Folio, solicitud.TipoDocumentoId, solicitud.Concrecion, solicitud.NombreConcrecion, solicitud.RUTConcrecion, solicitud.VRUTConcrecion, solicitud.MotivoNoConcrecion);
